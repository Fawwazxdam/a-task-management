...
import { ArrowLeft, Edit, Moon, Sun } from 'lucide-react';
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <div className={`p-3 rounded-full ${isDarkMode ? 'bg-gray-700' : 'bg-blue-100'}`}>
                <Edit className={`w-6 h-6 ${isDarkMode ? 'text-blue-400' : 'text-blue-600'}`} />
              </div>
              <h1 className={`text-3xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Edit Tugas</h1>
            </div>
          </div>
          <button
